...
import { fetchGatewayPaymentsForCustomer } from "@/lib/payments/gateway-payments-query-service";
...
export async function GET(_request: Request, context: RouteContext) {
  ...
  try {
    const data = await fetchGatewayPaymentsForCustomer(gate.access.tenantId, id);
